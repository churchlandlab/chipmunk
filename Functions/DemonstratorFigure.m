...
switch figMethod
    ...
    case 'init'
        %Generate figure
        BpodSystem.GUIHandles.Figures.DemonFigure = figure('Units','Normal','Position',[0.5, 0.06, 0.5, 0.9],...
        ...
        uicontrol('Parent', BpodSystem.GUIHandles.PerformanceSummaryPanel,'Units', 'normal', 'Position',[0.05,0.35,2/3,0.2],'style', 'text', 'String','Rewarded:','HorizontalAlignment','right');
        ...
        BpodSystem.GUIHandles.LabelsVal.rewardedTrials = uicontrol('Parent', BpodSystem.GUIHandles.PerformanceSummaryPanel,'Units', 'normal', 'Position',[2/3+0.1,0.35,1/3-0.1,0.2],'style', 'text', 'String','0','HorizontalAlignment','left');
        ...
        BpodSystem.GUIHandles.StateLogic = axes('Parent', BpodSystem.GUIHandles.DemonTabGroup.TaskControl,...
            'Units', 'Normal', 'Position', [0.05, 0.55, 0.9, 0.4]);
        title('State logic')
