...
%             'Position', [0.35, 0.32, 0.3, 0.12],'Title','Demonstrator initiation','FontWeight','bold');
        ...
        BpodSystem.GUIHandles.OmissionViolationPanel = uipanel('Parent', BpodSystem.GUIHandles.DemonTabGroup.TaskControl, 'Units', 'Normal',...
...
%         
        ...
        BpodSystem.GUIHandles.ParamEdit.propOutcomeOmissions = uicontrol('Parent', BpodSystem.GUIHandles.OmissionViolationPanel,...
            'Units', 'normal', 'Position',[2/3+0.025,2/3,1/3-0.025,1/3],'style', 'edit', 'String',BpodSystem.ProtocolSettings.propOutcomeOmissions);
        end
        if isfield(BpodSystem.ProtocolSettings, 'propRuleViolations')
        BpodSystem.GUIHandles.ParamEdit.propRuleViolations = uicontrol('Parent', BpodSystem.GUIHandles.OmissionViolationPanel,...
