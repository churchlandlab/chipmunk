...
%             'Units', 'normal', 'Position',[2/3+0.025,0,1/3-0.025,1/3],'style', 'edit', 'String',BpodSystem.ProtocolSettings.trialStartDelayLambda);
        ...
        uicontrol('Parent', BpodSystem.GUIHandles.ObsVirtualDemonPanel,'Units', 'normal', 'Position',[0,0.75-0.05,2/3,0.25],'style', 'text', 'String','virtTrialDurMin','HorizontalAlignment','right');
        uicontrol('Parent', BpodSystem.GUIHandles.ObsVirtualDemonPanel,'Units', 'normal', 'Position',[0,0.5-0.05,2/3,0.25],'style', 'text', 'String','virtTrialDurMax','HorizontalAlignment','right');
        uicontrol('Parent', BpodSystem.GUIHandles.ObsVirtualDemonPanel,'Units', 'normal', 'Position',[0,0.25-0.05,2/3,0.25],'style', 'text', 'String','virtTrialDurLambda','HorizontalAlignment','right');
        
        BpodSystem.GUIHandles.ParamEdit.virtTrialsDurMin = uicontrol('Parent', BpodSystem.GUIHandles.ObsVirtualDemonPanel,...
            'Units', 'normal', 'Position',[2/3+0.025,0.75,1/3-0.025,0.25],'style', 'edit', 'String','');
        BpodSystem.GUIHandles.ParamEdit.virtTrialsDurMax = uicontrol('Parent', BpodSystem.GUIHandles.ObsVirtualDemonPanel,...
            'Units', 'normal', 'Position',[2/3+0.025,0.5,1/3-0.025,0.25],'style', 'edit', 'String','');
        BpodSystem.GUIHandles.ParamEdit.virtTrialsDurLambda = uicontrol('Parent', BpodSystem.GUIHandles.ObsVirtualDemonPanel,...
            'Units', 'normal', 'Position',[2/3+0.025,0.25,1/3-0.025,0.25],'style', 'edit', 'String','');
        %-----------
