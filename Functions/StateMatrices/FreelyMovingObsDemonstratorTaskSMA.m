function [sma, trialDelays, reviseChoiceFlag, pacedFlag] = FreelyMovingObsDemonstratorTaskSMA(correctSideOnCurrent);
...
sma = AddState(sma,'Name', 'DemonReward',...
    ...
    'OutputActions', {'SoftCode',255,'ValveState', RewardValve,'PWM2',255, incorrectPortLED, 255});
...
sma = AddState(sma, 'Name', 'DemonWrongChoice',...
    ...
    'OutputActions', {'PWM1',255,'PWM2',255,'PWM3',255,'SoftCode',255});
...
sma = AddState(sma, 'Name', 'DemonWrongChoicePunishment',...
    ...
    'StateChangeConditions', {'Tup','FinishTrial'},...
    'OutputActions', {'PWM1',255,'PWM2',255,'PWM3',255,'SoftCode', 5});
...
sma = AddState(sma, 'Name', 'DemonEarlyWithdrawal',...
    ...
    'OutputActions', {'SoftCode',255,'PWM1',255,'PWM2',255,'PWM3',255}); 
