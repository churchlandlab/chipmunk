...
%evaluate observer fixation success later. Bit 33 to teensy signals
%non-initiation and will be treated like unsucessful fixation without
%punishment. Since the demonstrator did not wait long enough this will be
%counted as an early withdrawal and Bpod will directly jump to
%DemonEarlyWithdrawal.
...
%that tells the demonstrator that it can leave the poke now. Judge as early
%withdrawal when the mouse leaves right at the moment.
